                    ...
                    <div class="admin_main ">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form enctype="multipart/form-data" method="post" class="admin-add-some admin-add-slider" id="admin-add-slider" name="adminAddSlider">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group form-md-line-input form-md-floating-label">
                                        ...
                                        <textarea name="textSliderRu" id="slider-text-ru" type="text" class="form-control" placeholder="Текст слайдера на Русском"></textarea>
                                    </div>

                                        <div class="form-group form-md-line-input form-md-floating-label">
                                            <p class="incorect-input incorect-editor-uk"><i class="fas fa-exclamation-triangle"></i>Введите текст на Украинском!</p>
                                            <textarea name="textSliderUk" id="slider-text-uk" type="text" class="form-control" placeholder="Текст слайдера на Украинском"></textarea>
                                        </div>
                                    ...
                                    <div class="input-group choose-img">
                                        <label class="input-group-btn">
                                            <span class="btn-choose-img">
                                                Выбрать картинку<input name="slider-img" id="slider-input-img" type="file" style="display: none;" multiple>
                                            </span>
                                        </label>
                                    ...
                                    <div class="btn-wrapper">
                                        <button type="submit" id="addSlider" class="btn btn-make-app btn-spiner">
                                            <div class="spinner">
