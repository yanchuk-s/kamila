    ...
    <div class="col-md-12">
        <nav class="pagination-wrapper">
            <ul class="pagination">
                ...
                @if($isPrev)
                    <li class="pagi-inner">
                        <a href="/blogs-list/{{ $model->page - 1 == 1 ? '' : $model->page - 1 }}" aria-label="Previous" class="pagi-link">
                ...
                @foreach($pages as $page)
                    <li class="pagi-inner {{ $page == $model->page ? 'active' : '' }}">
                        ...
                        @else
                            ...
                            @else
                                <a href="/blogs-list/{{ $page == 1 ? '' : $page }}" class="pagi-link">
                                    {{ $page }}
                                </a>
                            @endif
                        @endif
                ...
                @if($isNext)
                    <li class="pagi-inner">
                        <a href="/blogs-list/{{ $model->page + 1 }}" aria-label="Next" class="pagi-link">
